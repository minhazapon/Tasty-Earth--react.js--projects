...
const Order = () => {
    return (
        <div className="  mt-36  mb-28 ml-10 mr-10">
      ...
      >
        ...
        <h1 className='  ml-10 -mt-24 text-5xl text-white font-bold'>sushi</h1>
        ...
        <SwiperSlide>
          ...
          <h1 className='  ml-10 -mt-24 text-5xl text-white font-bold'>pasta</h1>
        ...
        <SwiperSlide>
          ...
          <h1 className='  ml-10 -mt-24 text-5xl text-white font-bold'>tacos</h1>
        ...
        <SwiperSlide>
          ...
          <h1 className='  ml-10 -mt-24 text-5xl text-white font-bold'>salad</h1>
        ...
        <SwiperSlide>
          ...
          <h1 className='  ml-10 -mt-24 text-5xl text-white font-bold'>burger</h1>
        ...
        <SwiperSlide>
          ...
          <h1 className='  ml-10 -mt-24 text-5xl text-white font-bold'>Stir-fry
          </h1>
        ...
        <SwiperSlide>
          ...
          <h1 className='  ml-10 -mt-24 text-5xl text-white font-bold'>Lasagna</h1>
        ...
        <SwiperSlide>
          ...
          <h1 className='  ml-10 -mt-24 text-5xl text-white font-bold'>curry</h1>
